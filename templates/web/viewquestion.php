                        ...
                        <div class="category-tab" ><!--category-tab-->
                            ...
                            <div style="color:red; font-size:13px; font-weight:bold; margin-top:10%;  border:1px  dashed #CCC; padding:3px;">         
                                ...
                                <div style="margin-top: 5%; color: blue; text-align: left;">
                                       <!--<a href="ask_legal?id=<?php // echo $query2['fee_id'];  ?>"><button  type="button" style="background:#054F73;margin-left: 2%; color: white" class="btn btn-default">Replay</button></a>-->
                                    ...
                                    <table align="center" width="800">
                                            ...
                                            <tr><td style="font-size: 15px; color: #000;">  <img src="admin/images/hed.jpg" width="25px" height="25px;" style="margin-left:1%;"/><br>
