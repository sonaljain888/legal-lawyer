                ...
                <div class="category-tab" ><!--category-tab-->
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="col-sm-12">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="" data-toggle="tab">User Update Account</a>
                                </li>
                            ...
                            <form id="form_background" action="#" method="POST" enctype="multipart/form-data" >
                                ...
                                <table height="680" align="center" width="80%">
                                    ...
                                    <tr>
                                        ...
                                        <td><input id="text"type="email" name="email" /></td>
                                    </tr>

                                    <tr>
                                        <td id="label">Mobile No:</td>
                                        <td><input id="text"type="text" name="mobile" /></td>
                                    </tr>
                                    <tr>
                                        <td id="label">Website:</td>
                                        <td><input id="text" type="url" name="website" /></td>
                                    </tr>
                                    <tr>
                                        <td id="label">Address:</td>
                                        <td><input id="text" type="text" name="add" /></td>
                                    </tr>
                                    <tr>
                                        <td id="label">Practicing City:</td>
                                        <td><input id="text" type="text" name="city" /></td>
                                    </tr>
                                    <tr>
                                        <td id="label">Area / Locality:</td>
                                        <td><input id="text"  name="location" type="text" /></td>
                                    </tr>
                                    <tr>
                                        <td id="label">Experience (in years):</td>
                                        <td><input id="text"  name="experience" type="text" /></td>
                                    </tr>
                                    <tr>
                                        <td id="label">Educational Details:</td>
                                        <td><input id="text"  name="education" type="text"/></td>
                                    </tr>
                                    <tr>
                                        <td id="label">Specialization:</td>
                                        <td><input id="text"  name="specialization" type="text" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="2" align="center">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input type="submit" value="Submit" name="submit" id="edituser" />
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="button" value="Cancel" id="editusercancle" />  
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
