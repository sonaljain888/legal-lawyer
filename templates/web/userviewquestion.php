                    ...
                    <div class="col-sm-9 padding-right">
                        ...
                        <div class="category-tab" ><!--category-tab-->
                            ...
                            <div style="color:red; font-size:13px; font-weight:bold; margin-top:10%;  border:1px  dashed #CCC; padding:3px;">         
                                We would highly recommend you to use our paid program. It will rapidly increase the accuracy, response time, privacy and you can get 10-20 lawyers opinion on the same question in detail. Also you can continue ask the question till you get a satisfied answer. 



                                <div style="margin-top: 5%; color: blue; text-align: left;">
                                       <!--<a href="userask_legal?id=<?php // echo $query2['fee_id'];  ?>"><button  type="button" style="background:#054F73;margin-left: 2%; color: white" class="btn btn-default">Replay</button></a>-->
                                    ...
                                    <table align="center" width="800">
                                            ...
                                            <tr><td style="font-size: 15px; color: #000;">  <img src="admin/images/hed.jpg" width="25px" height="25px;" style="margin-left:1%;"/><?php echo $query2['heading']; ?><br>
                                                    <img src="admin/images/qu.jpg" width="30px" height="30px;" style="margin-left:1%;"/><?php echo $query2['question']; ?>
    ...
    <?php // include 'include/recommended.php';  ?>
                                    ...
                                    <form id="form_background" action="#" method="POST" enctype="multipart/form-data">
                                        <table style="width: 50%;margin-left:10%;background: #CCC;text-align: center;margin-top: 
                                               5%;">
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="4" align="center"><input type="button" value="delete" name="edit" style="width:80px;background: red;height: 40px;color: white;margin-top: 2%;" /></td></tr>
                                    ...
                                    <p style="margin-top: 10%;color: red;">Note:- Legal Lawyer has no control over the questions/answers provided by the user/expert/lawyer. Legal lawyer will not be responsible incase of any issues/discrepancies with the questions and answers. <h style="color:blue;">Disclaimer</h></p>
                                </div>
                            </div>
