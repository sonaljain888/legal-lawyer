            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="../main_menu_show.php"><i class="glyphicon glyphicon-home"></i><span> Dashboard</span></a>
                        </li>
                        <li class="accordion">
                            <a href="#"><i class="glyphicon glyphicon-plus"></i><span> Manage Location</span></a>
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="../country1.php"><span> Country</span></a></li>
                                <li><a href="../state.php"><span> State</span></a></li>
                                <li><a href="../city.php"><span> City</span></a></li>
                            </ul>
                        </li>
                        <li class="accordion">
                            <a href="#"><i class="glyphicon glyphicon-plus"></i><span> Page Menu Category</span></a>
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="../index1.php"><span> For Lawyer</span></a></li>
                                <li><a href="../for_user.php"><span> For User</span></a></li>
                                <li><a href="../for_lawyer_admin.php"><span> For Admin Lawyer</span></a></li>
                            </ul>
                        </li>
                        <li class="accordion">
                            <a href="#"><i class="glyphicon glyphicon-plus"></i><span> Manage Advice</span></a>
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="../free-legal-advice.php"><span> Free Legal Advice</span></a></li>
                                <li><a href="../paid_legal_advice.php"><span> Paid Legal Advice</span></a></li>
                           </ul>
                        </li>
                        <li class="accordion">
