            ...
            <div class="box-content">
                <div class="control-group">
                    ...
                    <input type="file" name="file" value="" class="form-control" required="">
                        ...
                        <tr>
                            <td  colspan="2"><button  type="submit" name="submit" style="background: black;margin-left: 20%; color: white" class="btn btn-default">Submit</button>&nbsp;&nbsp;&nbsp;<a href="type_doc_subcat.php"><button  type="button" style="background: black; color: white" class="btn btn-default">cancel</button></a></td>
                        </tr>
                    </table>
