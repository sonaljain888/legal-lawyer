              ...
              <div class="box-content" >
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="created_date" value="" class="form-control" placeholder="Date" required="">
                        ...
                        <tr>
                            <td style="text-align: center" colspan="2"><button type="submit" name="edit" style="background: black;color: white;" class="btn btn-default">Submit</button>&nbsp;&nbsp;&nbsp;<a href="index1.php"><button type="button" style="background: black;color: white;" class="btn btn-default">cancel</button></a></td>
                        </tr>
                    </table> 
                    </form>
