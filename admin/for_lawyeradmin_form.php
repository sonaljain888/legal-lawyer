            ...
            <div class="box-conten" >
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="date" name="created_date" class="form-control" placeholder="Date" required="">
                        ...
                        <tr>
                            <td style="text-align: center" colspan="2"><button type="submit" name="submit" style="background: black;color: white;" class="btn btn-default">Submit</button>&nbsp;&nbsp;&nbsp;<a href="for_lawyer_admin.php"><button type="button" style="background: black;color: white;" class="btn btn-default">cancel</button></a></td>
                        </tr>
                    </table> 
                    </form>
            </div>
