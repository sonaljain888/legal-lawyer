                   ...
                   <form action="#" method="POST">
                    ...
                    <input type="text" name="state" value="" class="form-control" placeholder="State" required="">
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" name="isactive_state" value="" /></td>
                        </tr>
                        <tr>
                            <td  colspan="2"> <button  type="submit" name="edit" style="background: black;margin-left: 20%; color: white" class="btn btn-default">Submit</button>&nbsp;&nbsp;&nbsp;<a href="state.php"><button  type="button" style="background: black; color: white" class="btn btn-default">cancel</button></a></td>
                        </tr>
                    </table>
